 ...
 *              K is hashed with a prefix, say by month/year in a timeseries
 *              this can mean it can hit the same shard
 *              Sharded by K
 */
public class UniqueUsersKeyPrefixDbStore {

    private static final Logger logger = LogManager.getLogger(UniqueUsersKeyPrefixDbStore.class);
    private static final UniqueUsersKeyPrefixDbStore _instance = new UniqueUsersKeyPrefixDbStore();
    private UniqueUsersKeyPrefixDbStore(){}
    public static UniqueUsersKeyPrefixDbStore getInstance(){return _instance;}
